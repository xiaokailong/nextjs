                ...
                >
                  ...
                  <CardBody className="pt-0">
                    ...
                    <div className="mb-4">
                      ...
                      <div 
                        className="text-sm text-gray-600 bg-gray-50 p-3 rounded-lg border border-gray-200 prose prose-sm max-w-none"
                    ...
                    <div>
                      ...
                      <div 
                        className="text-sm text-gray-700 bg-blue-50 p-3 rounded-lg border border-blue-200 prose prose-sm max-w-none"
